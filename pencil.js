...
function initPencilMotions() {
      ...
      // keyframes for pencil:    name, dt, [x, z, squish]
    pencilMotion.addKeyFrame(new Keyframe('keyA', 0.0, [7, -2, 2]));
    pencilMotion.addKeyFrame(new Keyframe('keyB', 2.0, [12, 2, 0.5]));
    pencilMotion.addKeyFrame(new Keyframe('keyA', 2.0, [7, -2, 2]));
    pencilMotion.addKeyFrame(new Keyframe('keyB', 2.0, [2, 2, 0.5]));
    pencilMotion.addKeyFrame(new Keyframe('keyA', 2.0, [7, -2, 2]));
}
...
function updatePencil(avars) {
    pencil.position.set(2,7,avars[0]);
